                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-">
                            <h1 class="page-header-title">
                                ...
                                <a href="<?php echo base_url('administrator/ruangan/detail/' . $sub_ruang->kode_utama); ?>" class="btn btn-primary btn-back">
                                    <div class="box-icon">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- Form Edit -->
                                                <form action="<?php echo base_url('administrator/Alat/update_aksi/' . $sub_ruang->kode_ruang); ?>" method="POST">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?php echo base_url('administrator/alat/hapus/' . $sub_ruang->kode_ruang); ?>" class="btn btn-danger">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
