                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            <a href="<?php echo base_url('administrator/home'); ?>" class="btn btn-primary btn-back">
                                <div class="box-icon">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="<?php echo base_url('administrator/ruangan/delete/' . $ruangan_item->kode_ruang); ?>">Hapus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="editModal<?php echo $key; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo base_url('administrator/ruangan/update'); ?>" method="POST">
