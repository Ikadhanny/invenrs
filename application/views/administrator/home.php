                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto mt-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <form class="d-flex" action="<?php echo base_url('administrator/home/tambahRuangan'); ?>" method="POST">
                        ...
                        <form action="<?php echo base_url('administrator/home/tambahRuangan'); ?>" method="POST">
                                        ...
                                        <div class="card card-icon lift lift-sm mb-4">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="<?php echo base_url('administrator/ruangan/detail/' . $ruangan_item->kode); ?>"><?php echo $ruangan_item->nama; ?></a>  
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a class="btn btn-danger" href="<?php echo base_url('administrator/home/delete/' . $ruangan_item->kode); ?>">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="editModal<?php echo $key; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?php echo base_url('administrator/home/update'); ?>" method="POST">
