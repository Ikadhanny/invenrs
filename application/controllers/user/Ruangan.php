...
class Ruangan extends CI_Controller
{
  ...
  public function detail($kode)
  {
    ...
    $this->load->view('users/jenis_ruangan', $data);
  ...
  if (!$ruangan) {
    ...
    redirect('user/ruangan/detail/' . $data['kode_utama']);
// Ganti 'users/ruangan' dengan halaman tujuan setelah data disimpan
}
    ...
    redirect('user/ruangan/detail/' . $kodeUtama);
    }
    ...
    public function delete($kode)
    {
        ...
        redirect('user/ruangan?message=' . urlencode($message));
    }
