...
class Alat extends CI_Controller
{
  ...
  public function detail($kodeRuang)
  {
    ...
    // Memuat view 'user/sub_ruang'
    $this->load->view('user/header');
    $this->load->view('user/sidebar');
    $this->load->view('users/jenis_alat', $data);
  ...
  public function simpanAlat()
  {
    ...
    redirect('user/Alat/detail/' . $kode_ruang); // Redirect ke halaman daftar alat
  }
  ...
  public function update($kode_ruang)
  {
    ...
    $this->load->view('user/header');
    $this->load->view('user/sidebar');
    $this->load->view('users/Alat', $data);
    $this->load->view('user/footer');
  }
  ...
  public function update_aksi($kode_ruang)
  {
    ...
    redirect('user/Alat/detail/' . $kode_ruang);
  }
